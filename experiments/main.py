...
X1, Y, loader, test_X1, test_Y, vocab_size =  gpt_tokens(train_sentences, train_labels, test_sentences, test_labels)
train_eval(X1, Y, loader, test_X1, test_Y, vocab_size, 1, 20)
...
X1, Y, loader, test_X1, test_Y, vocab_size =  gpt_multitok_tokens(train_sentences, train_labels, test_sentences, test_labels, 2, 1)
train_eval(X1, Y, loader, test_X1, test_Y, vocab_size, 1, 20)
